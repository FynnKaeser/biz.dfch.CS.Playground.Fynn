...
using biz.dfch.CS.Playground.Fynn.Design_Patterns_Guru.Factory_Pattern;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace biz.dfch.CS.Playground.Fynn.Tests.Design_Patterns_Guru.Factory_Pattern
{
    [TestClass]
