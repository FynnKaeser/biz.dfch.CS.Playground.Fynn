...
{
    [TestClass]
    public class AClassNetworkConfigurationTest
    {
        [TestMethod]
        public void SetIpAddressSucceeds()
        {
            ...
            var sut = new AClassNetworkConfiguration(device);
            ...
            var resultSection1 = section1 >= sectionMin && section1 <= section1Max; 
        ...
        public void InitializeAClassNetworkConfigurationWithNullDeviceObjectThrowsArgumentNullException()
        {
            // Arrange
            // Act
            var sut = new AClassNetworkConfiguration(null);
