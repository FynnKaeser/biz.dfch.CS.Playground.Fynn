...
{
    [TestClass]
    public class EClassNetworkConfigurationTest
    {
        ...
        public void InitializeEClassNetworkConfigurationWithNullDeviceObjectThrowsArgumentNullException()
        {
            // Arrange
            // Act
            var sut = new EClassNetworkConfiguration(null);
