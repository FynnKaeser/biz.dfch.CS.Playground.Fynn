...
namespace biz.dfch.CS.Playground.Fynn.Tests.Design_Patterns_Guru.Abstract_Factory_Pattern
{
    ...
    public class ProductA2Test
    {
        ...
        public void EqualsMethodReturnsExpectedResult()
        {
            ...
            var sut = new ProductA2(arbitraryName, arbitraryIpAddress);
            var otherSut = new ProductA2(arbitraryName, arbitraryIpAddress);
        ...
        public void CreateProductA2WithInvalidNameSetsDefaultName(string invalidName)
        {
            // Arrange
            ...
            // Act
            var result = new ProductA2(invalidName, arbitraryIpAddress);
        ...
        public void CreateProductA2WithInvalidIpAddressSetsDefaultIpAddress(string invalidIpAddress)
        {
            // Arrange
            ...
            // Act
            var result = new ProductA2(arbitraryName, invalidIpAddress);
